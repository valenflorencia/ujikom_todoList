<div class="container position-relative z-1">
    ...
    <div class="row my-3">
        <div class="col-6 mx-auto">
            ...
            <form action="{{ route('home') }}" method="GET"
                ...
                <input type="text" class="form-control border-0 shadow-sm rounded-pill px-3" name="query"
    ...
    @if ($lists->count() !== 0)
        ...
        <div class="d-flex justify-content-center mt-4 py-4">
            <button type="button"
                class="btn btn-outline-primary flex-shrink-0 rounded-pill shadow-lg px-5 py-3 fw-semibold"
                style="width: 15rem; height: fit-content; transition: all 0.3s ease-in-out;" data-bs-toggle="modal"
