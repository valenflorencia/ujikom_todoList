    ...
    <div id="content" class="overflow-y-hidden overflow-x-hidden">
        ...
        @if ($lists->count() == 0)
            <div class="d-flex flex-column align-items-center">
                ...
                <button type="button" class="btn btn-outline-success btn-sm d-flex align-items-center gap-2"
        ...
        <div class="d-flex gap-3 px-3 flex-nowrap overflow-x-scroll overflow-y-hidden" style="height: 100vh;">
                                    ...
                                    @if (!$task->is_completed)
                                        <div class="card-footer">
                                            <form action="{{ route('tasks.complete', $task->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="btn btn-sm btn-dark bg-success w-100">
            ...
            @endforeach
            @if ($lists->count() != 0)
                <button type="button" class="btn bg-success flex-shrink-0 btn-dark"
